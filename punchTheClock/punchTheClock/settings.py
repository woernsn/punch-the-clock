"""
Django settings for punchTheClock project.
...
ROOT_URLCONF = 'punchTheClock.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'app.context_processors.open_timelog_processor',
            ],
        },
    },
]
...
# PunchTheClock specific settings
# DOTENV_PATH = BASE_DIR / '.env'
TOKEN_LENGTH = 32
WEEKS_TO_SHOW = 8
SECRET = getenv('PTC_SECRET')
